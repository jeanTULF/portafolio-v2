...
return (
        <>
            <nav className="fixed p-6 md:p-10 z-50">
                <NavLink 
                to="/"
                className="flex gap-4 border-transparent px-5 py-3 md:p-3 rounded-xl items-center text-textDark dark:text-textDark text-sm font-semibold bg-gradient-to-b from-darkCardGradient-primary to-darkCardGradient-secondary dark:bg-gradient-to-b dark:from-darkCardGradient-primary dark:to-darkCardGradient-secondary dark:border dark:border-borderDark transform transition duration-300 hover:scale-110 ">
            ...
            <div className="bg-gradient-to-b from-primaryDark to-primaryDark 
                w-full h-full dark:bg-gradient-to-b dark:from-primaryDark dark:to-primaryDark flex flex-col items-center">
                    <section className="flex flex-col items-center gap-6 py-[200px]">
                        <h1 className="text-textDark font-semibold text-3xl lg:text-5xl dark:text-textDark">{title}</h1>
                        <img src={img} alt={alt} className="w-[90vw] max-w-[50rem] drop-shadow-md"/>
                            <div className="flex mt-24 gap-x-20">
                                ...
                                text-white transform transition duration-300 hover:scale-110 dark:from-buttonDark dark:to-buttonDark dark:text-white">
                                    Ver Demo 
                                </Button>
                    ...
                    <section className="max-w-4xl mx-auto w-[90vw] grid lg:grid-cols-2 gap-8 px">
                        <div className="p-4 border border-borderDark rounded-lg dark:border-borderDark">
                            <h2 className="text-xl text-textDark font-bold mb-2 dark:text-textDark">Mi rol</h2>
                            <p className="text-textDark font-normal dark:text-textDark">FrontEnd</p>
                        </div>
                        <div className="p-4 border border-borderDark rounded-lg dark:border-borderDark">
                            <h2 className="text-xl text-textDark font-bold mb-2 dark:text-textDark">Resumen</h2>
                            <p className="text-sm text-textDark dark:text-textDark">{extDescription}</p>
                        </div>
                        <div className="p-4 border border-borderDark rounded-lg dark:border-borderDark">
                            <h2 className="text-xl text-textDark font-bold mb-2 dark:text-textDark">Equipo</h2>
                            <p></p>
                        </div>
                        <div className="p-4 border border-borderDark rounded-lg dark:border-borderDark">
                            <h2 className="text-xl text-textDark font-bold mb-2 dark:text-textDark">Tecnologías utilizadas</h2>
                            {selectedProject.tecnologies.map((tecno, index) => {
                                return(
                                <ul key={index} className="flex flex-col">
                                    <li className="text-sm text-textDark my-1 dark:text-textDark">{tecno}</li>
                                </ul>
                                )
                            })}
                        </div>
                    ...
                    <section className="flex flex-col items-center gap-6 my-[200px] rounded-xl bg-gradient-to-b from-darkCardGradient-primary to-darkCardGradient-secondary dark:bg-gradient-to-b dark:from-darkCardGradient-primary dark:to-darkCardGradient-secondary dark:border-borderDark max-w-[864px] w-[90vw] p-12">
                        <h2 className="text-textDark font-semibold text-2xl dark:text-textDark">Puntos destacados</h2>
                        <p className="text-textDark text-sm md:text-base dark:text-textDark">{highlight}</p>
                            <h3 className="text-textDark font-semibold text-2xl dark:text-textDark">Capturas</h3>
