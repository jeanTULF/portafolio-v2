...
export const NavBar = () => {
    /* const [theme, setTheme] = useState(() => {
      ...
      /* const handleChangeTheme = () => {
        setTheme((prevTheme) => (prevTheme === "dark" ? "dark" : "dark"));  /* !Refactorización para que quede modo oscuro permanente */
     // }; 
    return (
        <Navbar className="w-full sticky top-0 z-50" theme={{root: {base: 'drop-shadow-md px-2 py-2.5 sm:px-4 bg-primaryDark backdrop-filter backdrop-blur-lg bg-opacity-5'}}} fluid>
