        ...
        <> 
            <div className="flex flex-col items-center w-full h-full gap-[50px] backgroundContact">
                <div className=" py-12 flex flex-col items-center gap-5 z-10 drop-shadow-md w-[80%] md:w-[60%] lg:w-[40%]">
                    <h1 className=" font-bold text-3xl sm:text-5xl text-textDark">Contactame</h1>
                    <p className=" text-sm sm:text-base text-center text-textDark">
                ...
                <div className="flex flex-col items-center z-10 drop-shadow-md gap-5">
                    <h1 className=" font-bold text-3xl sm:text-5xl text-textDark">Redes</h1>
                    <ul className="flex gap-4 text-white">
                        <li>
                        <a href="https://github.com/jeanTULF" target="_blank" className="hover:text-titleAccent transform transition duration-300">
                        ...
                        <li>
                        <a href="https://www.linkedin.com/in/jeanpolo15/" target="_blank" className="hover:text-titleAccent transform transition duration-300">
                            <svg xmlns="http://www.w3.org/2000/svg" width={50} height={50} viewBox="0 0 24 24">
                        ...
                        <li>
                        <a href="mailto:jeanpolo15@gmail.com" target="_blank" className=" hover:text-titleAccent transform transition duration-300">
                            <svg xmlns="http://www.w3.org/2000/svg" width={50} height={50} viewBox="0 0 24 24">
