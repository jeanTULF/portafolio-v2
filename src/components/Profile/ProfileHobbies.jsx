...
return (
        ...
        <div className="flex flex-col items-center gap-[100px] py-[100px]">
            <h1 className="text-titleAccent text-2xl font-semibold">Hobbies</h1>
            <div className="flex flex-col lg:flex-row items-center gap-8 lg:max-w-[60rem] lg:max-h-[29.4rem] p-5 rounded-lg border border-borderColor border-opacity-20 bg-gradient-to-b from-cardGradient-secondary to-cardGradient-primary drop-shadow-sm transition-transform ease-out duration-300 transform hover:scale-105">
                <img src="/assets/images/hobbies.png" alt="hobbies" className="max-w-96 max-h-72" />
