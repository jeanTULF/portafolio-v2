...
return (
        ...
        <div className="flex flex-col items-center gap-[100px] py-[100px]">
            <h1 className=" text-2xl font-semibold text-textDark">Hobbies</h1>
            ...
            border-opacity-20  
            bg-gradient-to-b from-darkCardGradient-primary to-darkCardGradient-secondary border-borderDark drop-shadow-sm transition-transform ease-out duration-300 transform hover:scale-105">
