...
return (
        ...
        <div className="flex flex-col items-center lg:w-[50%] gap-16 lg:flex-row">
                <div className="flex flex-col items-center gap-6 min-w-[320px] lg:min-w-[500px] lg:items-start">
                    <h1 className="font-extralight  text-textDark textSize">{"<Hola Mundo/>"}</h1>
                    <h3 className="text-textDark">
                        <span className="text-buttonDark">Soy </span> 
                        Jean Polo, desarrollador Front-
                        <span className="text-buttonDark">End</span> 
                        </h3>
                    <p className=" text-center text-sm lg:text-base lg:text-left max-w-[80%] lg:max-w-full text-textDark">
                        ...
                        <span className="text-buttonDark"> ¡Bienvenido a mi mundo digital!</span>   
                    </p>
                </div>
